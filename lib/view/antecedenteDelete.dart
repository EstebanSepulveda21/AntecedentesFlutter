...
class AntecedenteDelete extends StatefulWidget {
  @override
  _AntecedenteDeleteState createState() => _AntecedenteDeleteState();
}

class _AntecedenteDeleteState extends State<AntecedenteDelete> {
  int id = 0;
  String ciudadanoDi;
  int delitoCodigo;
  String ciudad;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Eliminar Antecedente"),
      ),
      body: Padding(
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    RaisedButton(
                      onPressed: _eliminarAntecedente,
                      child: Text("Eliminar"),
                    )
                  ],
                ),
  ...
  void _eliminarAntecedente() {
    if (globalKey.currentState.validate()) {
      ...
      Controller.eliminarAntecedente(antecedente.id);
      _finalizado();
    }
  }
  ...
  Future<void> _finalizado() {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Se ha Eliminado el Antecedente Correctamente',
